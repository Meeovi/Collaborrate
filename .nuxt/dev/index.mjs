...
import cache from 'file://C:/Users/sehilton/Documents/github/alternateframework/node_modules/memory-cache/index.js';
import { performance } from 'perf_hooks';
import { FilterXSS } from 'file://C:/Users/sehilton/Documents/github/alternateframework/node_modules/xss/lib/index.js';
import { defineCorsEventHandler } from 'file://C:/Users/sehilton/Documents/github/alternateframework/node_modules/@nozomuikuta/h3-cors/dist/index.mjs';
...
const _1i3gQcTCYy = (function(nitro) {
...
const _hwHeGJ = defineEventHandler(async (event) => {
...
const _cI8ND4 = defineEventHandler(async (event) => {
...
const _ro83CU = defineEventHandler(async (event) => {
...
const _Ggk9a1 = defineEventHandler(defineCorsEventHandler(securityConfig.corsHandler.value));
...
const handlers = [
  ...
  { route: '', handler: _hwHeGJ, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _cI8ND4, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _ro83CU, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Ggk9a1, lazy: false, middleware: false, method: undefined },
