...
const {
  ...
  onDOMContentLoaded,
  isRTL,
}= require('../mdb/util/index');
const FocusTrap= require('../mdb/util/focusTrap');
const { ENTER, TAB, ESCAPE }= require('../mdb/util/keycodes');
const Touch= require('../mdb/util/touch');
const Collapse= require('../bootstrap/mdb-prefix/collapse');
const Data= require('../mdb/dom/data');
const EventHandler= require('../mdb/dom/event-handler');
const Manipulator= require('../mdb/dom/manipulator');
const SelectorEngine= require('../mdb/dom/selector-engine');
const Ripple= require('../free/ripple');
