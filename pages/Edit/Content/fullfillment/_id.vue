                ...
                <v-table class="table">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <select id="pickup" :hint="fullfillment.pickup" name="template" class="form-category">
                    ...
                    <tr>
                      ...
                      <td>
                        <input :hint="fullfillment.stock" name="fullfillmentStock" type="number" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Company Name</td>
                      <td>
                        <input :hint="fullfillment.company" name="fullfillmentCompanyName" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">FullFillment Name</td>
                      <td>
                        <input :hint="fullfillment.name" type="text" required />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Phone Number</td>
                      <td>
                        <input :hint="fullfillment.phone" type="phone" placeholder="#" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Shipping Zones</td>
                      <td>
                        <select id="zones" :hint="fullfillment.shipping_zones" name="template" class="form-zones">
                    ...
                    <tr>
                      ...
                      <td>
                        <input :hint="fullfillment.address" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Address Line 2</td>
                      <td>
                        <input :hint="fullfillment.address_two" type="text" name="addressTwo" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">City</td>
                      <td>
                        <select id="category" :hint="fullfillment.city" name="template" class="form-category">
                    ...
                    <tr>
                      ...
                      <td>
                        <select id="category" :hint="fullfillment.state" name="template" class="form-category">
                    ...
                    <tr>
                      ...
                      <td>
                        <select id="countryArea" :hint="fullfillment.country_area" name="template" class="form-category">
                    ...
                    <tr>
                      ...
                      <td>
                        <select id="category" :hint="fullfillment.country" name="template" class="form-category">
                    ...
                    <tr>
                      ...
                      <td>
                        <input :hint="fullfillment.zipcode" name="fullfillmentZipcode" type="text" />
                      </td>
                    </tr>
                  </tbody>
                </v-table>
