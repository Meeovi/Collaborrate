                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input v-model="customer_name" name="customerName" type="text"
                          hint="Customer Name on the Invoice" required /></td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Bill to Name</td>
                      <td><input v-model="bill_to_name" name="orderNumber" type="number" hint="Who should we bill to?"
                          required /></td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Customer Email</td>
                      <td><input v-model="email" type="text" required
                          hint="Customer's Email used to email the invoice" /></td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Billing Address</td>
                      <td><input v-model="billing_address" type="text" hint="Billing address for this invoice"
                          required /></td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Customer Group</td>
                      <td><input v-model="customer_group" type="text" hint="Group this customer belongs to" /></td>
                    </tr>
                    <tr>
