                ...
                <v-table class="table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" :hint="warehouse.name" required />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Description</td>
                      <td>
                        <textarea :hint="warehouse.description" cols="40" rows="10"></textarea>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input :hint="warehouse.postal" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Products</td>
                      <td>
                        <input :hint="warehouse.products" type="text" />
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right;">Image</td>
                      <td>
                        <input v-model="image" type="image" hint="Select an image for the warehouse"
