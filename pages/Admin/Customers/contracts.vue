  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="/admin/edit/contract/add-new-contract"><input type="submit" class="btn btn-warning" value="Add New Contract"></a>
...
<script>
 import  contracts from '~/graphql/query/findManyContracts'
