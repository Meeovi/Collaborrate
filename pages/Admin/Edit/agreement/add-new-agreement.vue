...
<script>
  ...
  const ADD_AGREEMENTS = gql `
    ...
    createOneAgreements(data: {reference_id: $reference_id, user_id: $user_id, shop_id: $shop_id, content: $content, excerpt: $excerpt, image: $image, type: $type, name: $name} where: {id: $id}) {
      name
      excerpt
      type
      content
