...
<script>
  ...
  const ADD_SHIPMENTS = gql`
    ...
    createOneShipments(data: {carrier_name: $carrier_name, transit_time: $transit_time, image: $image, tracking_url: $tracking_url, product: $product, speed_grade: $speed_grade} where: {id: $id}) {
        carrier_name
        transit_time
        image
        tracking_url
