    ...
    <form @submit.prevent="addTemplate">
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand">
            <input type="submit" class="btn btn-warning" value="Save Template" /></a>
        </div>
      </nav>
      <br>
      <div class="row">
        <div class="col-3">
          ...
          <div id="v-tabs-tab" class="nav flex-column nav-tabs text-center" role="tablist" aria-orientation="vertical">
            <a id="v-tabs-home-tab" class="nav-link active" data-mdb-toggle="tab" href="#v-tabs-home" role="tab"
              aria-controls="v-tabs-home" aria-selected="true">Create A New Templates</a>
          </div>
          <!-- Tab navs -->
        </div>
                ...
                <table class="table">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <select id="active" v-model="active" name="template" class="form-category">
                    ...
                    <tr>
                      ...
                      <td>
                        <input v-model="assigned_to" type="text" placeholder="Can be a email address or a person!"/>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
<script>
  ...
  import findManyTemplates from "~/graphql/query/findManyTemplates";
      ...
      async addTemplate() {
        ...
        await this.$apollo.mutate({
          ...
          update: (cache, {
            ...
            try {
              const insertedTemplate = insertTemplates.returning;
