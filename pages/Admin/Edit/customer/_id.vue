<template>
  <div>
    <form v-for="customer in findManyCustomers" :key="customer.id" @submit.prevent="updateCustomer(customer)">
      <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand">
            <button type="reset" class="btn btn-warning" @click="deleteCustomer(customer)">Delete</button></a>
          <a class="navbar-brand">
        ...
        refetchQueries: [
          {
            ...
            this.$router.push({path: '../../customers/customers'})
