...
<template>
  <div>
    <form v-for="contract in findManyContracts" :key="contract.id" @submit.prevent="addContract">
        ...
        <div class="col-3">
          ...
          <div id="v-tabs-tab" class="nav flex-column nav-tabs text-center" role="tablist" aria-orientation="vertical">
            <a id="v-tabs-home-tab" class="nav-link active" data-mdb-toggle="tab" href="#v-tabs-home" role="tab"
              aria-controls="v-tabs-home" aria-selected="true">Edit Contract</a>
          </div>
          <!-- Tab navs -->
        </div>
...
<script>
  ...
  import
  findManyContracts
  from "~/graphql/query/findManyContracts";
  import findManyOpportunies from '~/graphql/query/findManyOpportunities'
...
const UPDATE_CONTRACT = gql`
  mutation updateOnecontracts($id: Int!){
  updateOneContracts(where: {id: {equals: $id}}){
    affected_rows
  }
}
`;
