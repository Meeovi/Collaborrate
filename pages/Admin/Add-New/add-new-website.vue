                    ...
                    <tr class="col-lg-6">
                      <td>
                        ...
                        <select id="category" v-model="category" name="template" class="form-category">
                          <option v-for="category in allCategoriesList" :key="category" :value="category">{{ category.name }}</option>
                        </select>
                      </td>
                    </tr>
                    <tr class="col-lg-6">
                      <td>
                        ...
                        <select id="shop" v-model="shop" name="template" class="form-category">
                          <option v-for="shop in allShopsList" :key="shop" :value="shop">{{ shop.name }}</option>
                        </select>
                      </td>
                    </tr>
                  </tbody>
...
import allShopsList from "~/apollo/queries/shop/shops"
