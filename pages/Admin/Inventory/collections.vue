  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="/admin/edit/collection/add-new-collection"><input type="submit" class="btn btn-warning" value="Create Collection"></a>
...
<script>
import  collections from '~/graphql/query/findManyCollections'
