  ...
  <div>
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="/admin/edit/attribute/add-new-attribute"><input type="submit" class="btn btn-warning" value="Add New Attribute"></a>
...
<script>
 ...
 import  product_attribute from '~/graphql/query/findManyAttributes'
