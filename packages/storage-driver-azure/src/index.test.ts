...
import { normalizePath } from '@alternatecms/utils';
import { isReadableStream } from '@alternatecms/utils/node';
...
vi.mock('@alternatecms/utils/node');
vi.mock('@alternatecms/utils');
