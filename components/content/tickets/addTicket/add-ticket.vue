                ...
                <form method="post" @v-on:submit.prevent="addTicket()">
                    ...
                    <v-card-text>
                        <v-container>
                            <v-row>
                                <v-col cols="6">
                                    <v-text-field v-model="name" id="categoryName" label="Ticket Name*" required></v-text-field>
                                </v-col>
                                <v-col cols="6">
                                ...
                                <v-col cols="12" sm="6">
                                    <v-file-input accept="image/*" label="Ticket Image"></v-file-input>
                                </v-col>
                            </v-row>
                        </v-container>
            ...
            addTicket() {
                ...
                this.$apollo.mutate({
                    ...
                    update: (store, {
                        ...
                        data.allCategories.push(addTicket)
                        store.writeQuery({
                            query: findManyCategories,
                            variables: {
                                first: 5,
