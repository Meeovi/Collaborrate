...
@TypeGraphQL.InputType("WorkspacesUpdateManyWithoutProducts_productsToworkspacesNestedInput", {
  isAbstract: true
})
export class WorkspacesUpdateManyWithoutProducts_productsToworkspacesNestedInput {
