...
@TypeGraphQL.InputType("WorkspacesUpdateManyWithoutCustomers_customersToworkspacesNestedInput", {
  isAbstract: true
})
export class WorkspacesUpdateManyWithoutCustomers_customersToworkspacesNestedInput {
