...
@TypeGraphQL.InputType("QuotesUpdateManyWithoutCustomers_customersToquotesNestedInput", {
  isAbstract: true
})
export class QuotesUpdateManyWithoutCustomers_customersToquotesNestedInput {
