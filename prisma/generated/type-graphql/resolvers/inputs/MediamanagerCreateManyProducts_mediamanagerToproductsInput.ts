...
@TypeGraphQL.InputType("MediamanagerCreateManyProducts_mediamanagerToproductsInput", {
  isAbstract: true
})
export class MediamanagerCreateManyProducts_mediamanagerToproductsInput {
