...
@TypeGraphQL.InputType("WorkspacesUpdateManyWithoutProjects_projectsToworkspacesNestedInput", {
  isAbstract: true
})
export class WorkspacesUpdateManyWithoutProjects_projectsToworkspacesNestedInput {
