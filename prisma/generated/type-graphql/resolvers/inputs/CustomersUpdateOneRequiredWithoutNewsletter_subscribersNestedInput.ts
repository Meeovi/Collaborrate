...
@TypeGraphQL.InputType("CustomersUpdateOneRequiredWithoutNewsletter_subscribersNestedInput", {
  isAbstract: true
})
export class CustomersUpdateOneRequiredWithoutNewsletter_subscribersNestedInput {
