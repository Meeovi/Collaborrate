...
@TypeGraphQL.InputType("Customer_paymentUpdateOneRequiredWithoutTransactionsNestedInput", {
  isAbstract: true
})
export class Customer_paymentUpdateOneRequiredWithoutTransactionsNestedInput {
