...
@TypeGraphQL.InputType("MediamanagerUpdateManyWithoutBrands_brandsTomediamanagerNestedInput", {
  isAbstract: true
})
export class MediamanagerUpdateManyWithoutBrands_brandsTomediamanagerNestedInput {
