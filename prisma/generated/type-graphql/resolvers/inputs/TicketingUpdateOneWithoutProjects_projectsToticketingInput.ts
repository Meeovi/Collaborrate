...
@TypeGraphQL.InputType("TicketingUpdateOneWithoutProjects_projectsToticketingInput", {
  isAbstract: true
})
export class TicketingUpdateOneWithoutProjects_projectsToticketingInput {
