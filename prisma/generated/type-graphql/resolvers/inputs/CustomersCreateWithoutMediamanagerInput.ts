...
@TypeGraphQL.InputType("CustomersCreateWithoutMediamanagerInput", {
  isAbstract: true
})
export class CustomersCreateWithoutMediamanagerInput {
  ...
  @TypeGraphQL.Field(_type => Newsletter_subscribersCreateNestedManyWithoutCustomersInput, {
    nullable: true
  })
