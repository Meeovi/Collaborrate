...
@TypeGraphQL.InputType("OccassionsUpdateManyWithoutProducts_occassionsToproductsInput", {
  isAbstract: true
})
export class OccassionsUpdateManyWithoutProducts_occassionsToproductsInput {
