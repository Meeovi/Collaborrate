...
@TypeGraphQL.InputType("OccassionsUpdateManyWithoutWishlists_occassionsTowishlistsInput", {
  isAbstract: true
})
export class OccassionsUpdateManyWithoutWishlists_occassionsTowishlistsInput {
