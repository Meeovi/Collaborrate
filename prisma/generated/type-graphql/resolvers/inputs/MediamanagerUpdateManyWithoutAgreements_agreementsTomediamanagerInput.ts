...
@TypeGraphQL.InputType("MediamanagerUpdateManyWithoutAgreements_agreementsTomediamanagerInput", {
  isAbstract: true
})
export class MediamanagerUpdateManyWithoutAgreements_agreementsTomediamanagerInput {
