...
@TypeGraphQL.InputType("ProductsCreateWithoutOccassions_occassionsToproductsInput", {
  isAbstract: true
})
export class ProductsCreateWithoutOccassions_occassionsToproductsInput {
  ...
  @TypeGraphQL.Field(_type => QuotesCreateNestedManyWithoutProducts_productsToquotesInput, {
    nullable: true
  })
