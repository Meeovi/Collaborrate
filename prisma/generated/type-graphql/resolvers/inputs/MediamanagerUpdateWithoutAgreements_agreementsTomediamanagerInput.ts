...
@TypeGraphQL.InputType("MediamanagerUpdateWithoutAgreements_agreementsTomediamanagerInput", {
  isAbstract: true
})
export class MediamanagerUpdateWithoutAgreements_agreementsTomediamanagerInput {
