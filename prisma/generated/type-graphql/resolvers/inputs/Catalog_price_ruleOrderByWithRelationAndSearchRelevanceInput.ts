...
import { Catalog_price_ruleOrderByRelevanceInput } from "../inputs/Catalog_price_ruleOrderByRelevanceInput";
import { SortOrder } from "../../enums/SortOrder";

@TypeGraphQL.InputType("Catalog_price_ruleOrderByWithRelationAndSearchRelevanceInput", {
  isAbstract: true
})
export class Catalog_price_ruleOrderByWithRelationAndSearchRelevanceInput {
  ...
  @TypeGraphQL.Field(_type => Catalog_price_ruleOrderByRelevanceInput, {
    nullable: true
  })
  _relevance?: Catalog_price_ruleOrderByRelevanceInput | undefined;
}
