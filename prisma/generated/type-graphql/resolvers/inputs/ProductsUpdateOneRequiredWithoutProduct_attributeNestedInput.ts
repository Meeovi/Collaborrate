...
@TypeGraphQL.InputType("ProductsUpdateOneRequiredWithoutProduct_attributeNestedInput", {
  isAbstract: true
})
export class ProductsUpdateOneRequiredWithoutProduct_attributeNestedInput {
