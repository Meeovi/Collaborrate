...
@TypeGraphQL.InputType("OccassionsUpdateWithoutWishlists_occassionsTowishlistsInput", {
  isAbstract: true
})
export class OccassionsUpdateWithoutWishlists_occassionsTowishlistsInput {
