...
import { UsersCreateNestedOneWithoutProjectsInput } from "../inputs/UsersCreateNestedOneWithoutProjectsInput";

@TypeGraphQL.InputType("ProjectsCreateWithoutWorkspacesInput", {
  isAbstract: true
})
export class ProjectsCreateWithoutWorkspacesInput {
  ...
  @TypeGraphQL.Field(_type => UsersCreateNestedOneWithoutProjectsInput, {
    nullable: true
  })
  users?: UsersCreateNestedOneWithoutProjectsInput | undefined;
