...
@TypeGraphQL.InputType("Product_attribute_setUpdateManyWithoutProduct_attributeNestedInput", {
  isAbstract: true
})
export class Product_attribute_setUpdateManyWithoutProduct_attributeNestedInput {
