...
@TypeGraphQL.InputType("MediamanagerUpdateManyWithoutProducts_mediamanagerToproductsNestedInput", {
  isAbstract: true
})
export class MediamanagerUpdateManyWithoutProducts_mediamanagerToproductsNestedInput {
