...
@TypeGraphQL.InputType("ProductsUpdateOneWithoutOccassions_occassionsToproductsInput", {
  isAbstract: true
})
export class ProductsUpdateOneWithoutOccassions_occassionsToproductsInput {
