...
@TypeGraphQL.InputType("TrainingsUpdateManyWithWhereWithoutProducts_productsTotrainingsInput", {
  isAbstract: true
})
export class TrainingsUpdateManyWithWhereWithoutProducts_productsTotrainingsInput {
