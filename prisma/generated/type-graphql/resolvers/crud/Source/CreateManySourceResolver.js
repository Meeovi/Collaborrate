...
exports.CreateManySourceResolver = void 0;
...
let CreateManySourceResolver = class CreateManySourceResolver {
...
], CreateManySourceResolver.prototype, "createManySource", null);
CreateManySourceResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Source_1.Source)
], CreateManySourceResolver);
exports.CreateManySourceResolver = CreateManySourceResolver;
