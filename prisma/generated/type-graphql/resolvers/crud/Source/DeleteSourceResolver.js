...
exports.DeleteSourceResolver = void 0;
...
let DeleteSourceResolver = class DeleteSourceResolver {
...
], DeleteSourceResolver.prototype, "deleteSource", null);
DeleteSourceResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Source_1.Source)
], DeleteSourceResolver);
exports.DeleteSourceResolver = DeleteSourceResolver;
