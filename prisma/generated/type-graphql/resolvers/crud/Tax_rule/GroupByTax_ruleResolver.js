...
exports.GroupByTax_ruleResolver = void 0;
...
let GroupByTax_ruleResolver = class GroupByTax_ruleResolver {
...
], GroupByTax_ruleResolver.prototype, "groupByTax_rule", null);
GroupByTax_ruleResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Tax_rule_1.Tax_rule)
], GroupByTax_ruleResolver);
exports.GroupByTax_ruleResolver = GroupByTax_ruleResolver;
