...
export class Cart_price_rulesCrudResolver {
  ...
  async deleteCart_price_rules(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteCart_price_rulesArgs): Promise<Cart_price_rules | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertCart_price_rules(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertCart_price_rulesArgs): Promise<Cart_price_rules> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
