...
exports.CreateRewardsResolver = void 0;
...
let CreateRewardsResolver = class CreateRewardsResolver {
...
], CreateRewardsResolver.prototype, "createRewards", null);
CreateRewardsResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Rewards_1.Rewards)
], CreateRewardsResolver);
exports.CreateRewardsResolver = CreateRewardsResolver;
