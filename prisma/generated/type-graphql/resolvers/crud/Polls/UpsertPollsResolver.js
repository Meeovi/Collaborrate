...
exports.UpsertPollsResolver = void 0;
...
let UpsertPollsResolver = class UpsertPollsResolver {
...
], UpsertPollsResolver.prototype, "upsertPolls", null);
UpsertPollsResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Polls_1.Polls)
], UpsertPollsResolver);
exports.UpsertPollsResolver = UpsertPollsResolver;
