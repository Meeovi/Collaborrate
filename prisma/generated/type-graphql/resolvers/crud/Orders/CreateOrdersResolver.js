...
exports.CreateOrdersResolver = void 0;
...
let CreateOrdersResolver = class CreateOrdersResolver {
...
], CreateOrdersResolver.prototype, "createOrders", null);
CreateOrdersResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Orders_1.Orders)
], CreateOrdersResolver);
exports.CreateOrdersResolver = CreateOrdersResolver;
