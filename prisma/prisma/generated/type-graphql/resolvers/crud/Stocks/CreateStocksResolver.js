...
exports.CreateStocksResolver = void 0;
...
let CreateStocksResolver = class CreateStocksResolver {
...
], CreateStocksResolver.prototype, "createStocks", null);
CreateStocksResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Stocks_1.Stocks)
], CreateStocksResolver);
exports.CreateStocksResolver = CreateStocksResolver;
