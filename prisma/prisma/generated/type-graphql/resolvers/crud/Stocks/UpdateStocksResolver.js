...
exports.UpdateStocksResolver = void 0;
...
let UpdateStocksResolver = class UpdateStocksResolver {
...
], UpdateStocksResolver.prototype, "updateStocks", null);
UpdateStocksResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Stocks_1.Stocks)
], UpdateStocksResolver);
exports.UpdateStocksResolver = UpdateStocksResolver;
