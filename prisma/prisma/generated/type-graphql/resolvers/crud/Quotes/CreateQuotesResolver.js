...
exports.CreateQuotesResolver = void 0;
...
let CreateQuotesResolver = class CreateQuotesResolver {
...
], CreateQuotesResolver.prototype, "createQuotes", null);
CreateQuotesResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Quotes_1.Quotes)
], CreateQuotesResolver);
exports.CreateQuotesResolver = CreateQuotesResolver;
