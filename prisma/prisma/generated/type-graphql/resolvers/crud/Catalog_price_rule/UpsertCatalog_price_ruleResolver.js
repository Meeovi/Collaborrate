...
exports.UpsertCatalog_price_ruleResolver = void 0;
...
let UpsertCatalog_price_ruleResolver = class UpsertCatalog_price_ruleResolver {
...
], UpsertCatalog_price_ruleResolver.prototype, "upsertCatalog_price_rule", null);
UpsertCatalog_price_ruleResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Catalog_price_rule_1.Catalog_price_rule)
], UpsertCatalog_price_ruleResolver);
exports.UpsertCatalog_price_ruleResolver = UpsertCatalog_price_ruleResolver;
